...
// Get bookings for an infrastructure (admin only)
router.get('/infrastructure/:infrastructureId', authenticateToken, verifyAdmin, async (req, res) => {
    try {
...
// Get available timeslots for an infrastructure with optional date filter
// This route could be used by both admins and regular users
router.get('/available/:infrastructureId', authenticateToken, async (req, res) => {
    try {
        const { infrastructureId } = req.params;
...
// Get all timeslots for an infrastructure (admin only)
router.get('/timeslots/:infrastructureId', authenticateToken, verifyAdmin, async (req, res) => {
    try {
        const { infrastructureId } = req.params;
        const { startDate, endDate } = req.query;
