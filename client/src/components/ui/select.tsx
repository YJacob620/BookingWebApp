...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "cursor-pointer def-hover border-input data-[placeholder]:text-muted-foreground " +
        ...
        "disabled:opacity-50 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center " +
        "*:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 " +
        "[&_svg:not([class*='size-'])]:size-4 [&>span]:line-clamp-1",
        className
      )}
      {...props}
    >
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "cursor-pointer def-hover focus:bg-accent focus:text-accent-foreground "
        + "[&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full items-center "
