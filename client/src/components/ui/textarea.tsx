  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        + " dark:aria-invalid:border-destructive dark:aria-invalid:ring-destructive/50 "
        + " field-sizing-content min-h-16 w-full rounded-md border bg-transparent "
        + " px-3 py-2 text-base shadow-xs transition-[color,box-shadow] focus-visible:ring-4 "
        + " focus-visible:outline-1 disabled:cursor-not-allowed disabled:opacity-50 "
