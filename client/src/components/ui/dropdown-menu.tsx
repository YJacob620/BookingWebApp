    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          + "data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[8rem] overflow-hidden rounded-md border p-1 shadow-md",
          className
        )}
        {...props}
      />
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "hover:cursor-pointer focus:bg-accent focus:text-accent-foreground data-[variant=destructive]:text-destructive "
        ...
        + "relative flex items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden "
