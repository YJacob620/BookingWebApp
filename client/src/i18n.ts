    ...
    resources: {
      ...
      he: {
        translation: {
          ...
          Users: "משתמשים",
          UsersDesc: "נהל משתמשים, הקצה תפקידים ושליטה על גישה לתשתיות",
          emailActHandler: {
            actProccesing: "פעולת עיבוד",
            ...
            rejMsg: "ההזמנה נדחתה. ",
            procMsg: "ההזמנה הזו כבר עובדה.  {{currentStatus}}ו",
            errMsg: "הייתה שגיאה בעיבוד בקשתך. ",
          },
          undefined: "לא מוגדר",
          "Please wait": "אנא המתן",
          "Please wait_dot": "אנא המתן.",
          "Go to Dashboard": "עבור אל לוח המחוונים",
          Infrastructures: "תשתיות",
          "Bookings & Timeslots": "הזמנות וזמנים",
          managerDash: {
            InfrastructuresDesc: "'נהל את התשתיות שהוקצו לך'",
            "Book&TimeDesc":
              "נהל בקשות הזמנה וחריצי זמן פנויים לתשתיות שהוקצו לך",
            title: "לוח מחוונים של Manageructure-Manager",
            explanation: "נהל את התשתיות שהוקצו לבקשות ההזמנה שלך",
          },
          welcomeHeader: "קַבָּלַת פָּנִים, {{name}}",
          adminDash: {
          ...
          userManagement: {
            msgErrUserLoad: "נכשל בהעמסת משתמשים",
            ...
            title: "ניהול משתמשים",
            searchBarPlaceholder: 'חיפוש במשתמשים בשם, בדוא"ל או בתפקיד ...',
          ...
          emailUnsubPage: {
            ...
            msgSucUnsub: 'הוצאתם בהצלחה בהודעות מהודעות דוא"ל.',
            msgErrProcReq: "אירעה שגיאה בעת עיבוד בקשת המנוי שלך.",
            "Unsubscribing from Emails": 'ביטול המנוי מהודעות דוא"ל',
            processingReq: "עיבוד בקשת המנוי שלך ...",
            "Successfully Unsubscribed": "שלא נרשם בהצלחה",
            "Unsubscribe Failed": "ביטול המנוי נכשל",
            unsubSuccessTxt:
              'שלא הוצאתם בהצלחה מכל התראות הדוא"ל ממערכת הזמנת התשתיות המדעיות.',
            ResubSuggestTxt:
              'אם אתה משנה את דעתך, אתה יכול להפעיל מחדש הודעות דוא"ל בכל עת על ידי כניסה לחשבונך ועדכון העדפותיך.',
            unsubErrTxt: "הייתה שגיאה בעיבוד בקשת המנוי שלך. ",
            unsubTryAgainTxt:
              'אנא נסה שוב או היכנס לחשבונך כדי לנהל את העדפות הדוא"ל שלך.',
          },
          bookTimeslot: {
            msgErrTsFetch: "טעינת שגיאות זמינות זמנים זמינים",
            "msgErrInf&Ts": "אנא בחר תשתית תקפה ו- Timeslot",
            msgErrName: "אנא הכנס את שמך",
            msgErrEmailEmpt: 'אנא הזן את כתובת הדוא"ל שלך',
            msgErrEmailInvalid: 'אנא הזן כתובת דוא"ל תקפה',
            msgErrGuestBook: "אירעה שגיאה בעת עיבוד ההזמנה שלך",
            msgErrInfTimeUnselected: "אנא בחר תשתית וזמנים",
            ...
            "Request a Booking": "בקש הזמנה",
            bookReqGuestExplain:
              "כאורח אתה יכול לבקש תור ללא חשבון, אך תהיה מוגבל לבקשה אחת ביום.",
            bookReqUserExplain: "מלא והגיש את הטופס לבקש הזמנה",
            ...
            submmitionExplain1: '1. תתבקש כתובת הדוא"ל שלך.',
          ...
          guestConfPage: {
            ...
            "Booking Confirmed!": "ההזמנה אושרה!",
            managerReviewExplain:
              'תקבל הודעת דוא"ל כאשר מנהל התשתית סוקר את בקשתך.',
