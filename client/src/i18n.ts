    ...
    resources: {
      en: {
        translation: {
          ...
          infrastructureManagementQuestions: {
            title: "Manage Filter Questions For {{infrast_name}}",
            currentQuestions: "Current Questions",
            noQuestionsAdded:
              "No filter questions added yet. Use the form below to add.",
      ...
      he: {
        translation: {
          ...
          "minutes": "דקות",
          "No answer provided": "לא ניתנה תשובה",
          "Updated past entries successfully": "עודכן בהצלחה",
          "Edit": "ערוך",
          "Delete": "מחק",
          ...
          "booking details": "פרטי הזמנה",
          Dashboard: "תפריט",
          "User Answers For Filter-Questions": "תשובות משתמש על שאלות סינון",
          ...
          userManagement: {
            ...
            manInfAccDesc: "הקצה או הסר גישה לתשתיות עבור {{who}}",
            noInfAbleMsg: "אין תשתיות זמינות",
            noInfResMsg: "אין תשתיות תואמות את קריטריוני החיפוש שלך.",
            "Un-blacklist": "הסר חסימה",
            Blacklist: "חסום משתמש",
          },
          Access: "גישה",
          Location: "מיקום",
          Status: "סטטוס",
          ...
          infrastructureManagementQuestions: {
            title: "נהל שאלות סינון לתשתית {{infrast_name}}",
            currentQuestions: "שאלות נוכחיות",
            noQuestionsAdded:
              "עדיין לא נוספו שאלות סינון. השתמש בטופס למטה כדי להוסיף.",
          ...
          SetInactive: "הפוך ללא פעילה",
          setInfrastInactiveWarning: "אזהרה: הפיכת תשתית ללא פעילה לא תבטל תורים שנקבעו אליה. האם להמשיך?",
          "setInfrastActive?": "להפוך תשתית זאת לפעילה?",
        },
      },
    },
  });
